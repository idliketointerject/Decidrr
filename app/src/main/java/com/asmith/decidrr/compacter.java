...
public class compacter {
    ...
    private static final String[] stopSet = new String[] {
            ...
            "de", "describe", "detail", "do", "done", "down", "did",
            ...
            "yourself", "yourselves", "THAT", "br", "it's", "if", "2", "I'm", "So",
            "THE", "IF", "If", "guy", "There", "A", "He", "3", "4", "1", "movie",
            "Movie", "David", "Vader", "Scott", "you're", "book", "tale", "Sandler",
            "Adam", "Prom", "Oh", "She", "Darth", "That's", "Alicia", "Pierce", "said",
            "von", "Julian", "William", "Then", "George", "Lucas", "just", "", "plot",
            "Davies", "Luke", "Burns", "Carla", "Star", "script", "Christmas", "think",
            "fantasy", "thing", "Brosnan", "films", "Matthau", "Stewart", "Scrooge",
            "chess", "scene", "film", "young", "story", "This", "music", "John", "Jeff",
            "battle", "looks", "played", "going", "actually", "point", "series", "reason",
            "scenes", "Ramones", "minutes", "plays", "watching", "money", "shows", "job"
    };

    private static Character[] trashCharacters = new Character[] {
            '.',',','"','!','?','{','}','(',')','[',']',':',';','<','>','/','@','#','$'
            ,'%','^','&','*','_','-','=','+','~','1','2','3','4','5','6','7','8','9','0'
    };
    public String takeOutTheTrash(String in){
        String out = in;
        for(Character x : trashCharacters){
            out = out.replace(x.toString(), "");
        }
        return out;
    }

    public ArrayList<String> removeStopWords(String[] in){
        ArrayList<String> out = new ArrayList<String>();
        for(String word : in) {
            boolean isInStopWords = false;
            for(String wword : stopSet){
                if(wword.equals(word)){
                    isInStopWords = true;
                    break;
                }
            }
